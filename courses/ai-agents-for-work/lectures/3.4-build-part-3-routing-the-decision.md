...
@narrate
Do the renames now, while you still remember why each box exists, and
before the next lecture's testing gives you something new to think
about. Double click, type the sentence, move on: it costs less than a
minute for the whole canvas, and it is the cheapest professionalism
available anywhere in this course. Six months from now, this workflow will be
...
The build is functionally complete: trigger, judgement, fork, two named
doors. What is missing is proof that it actually works, without you
spending a single real AI call to find out. That is next lecture.
