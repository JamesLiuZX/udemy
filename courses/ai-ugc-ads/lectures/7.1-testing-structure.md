...
```text
CAMPAIGN: Harlan Crew Sock, first test

AD SET 1  "Hour eleven" (clinical framing)     Budget: X
AD SET 2  "Hour eleven" (raw, unframed)        Budget: X
AD SET 3  "12-hour shift" hook                 Budget: X
AD SET 4  Founder-story angle                  Budget: X
...

Same audience, same placement, same budget, across
every ad set. Only the creative angle changes.
```
