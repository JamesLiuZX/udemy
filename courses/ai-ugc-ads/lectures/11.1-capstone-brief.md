...
notes: >-
  ...
  example to check your own work against.
---
...
| Stage | What you produce | Section |
| --- | --- | --- |
| Brief | Product truth doc, hook taxonomy, angle map | 2 |
| Generate | A batch of statics and video variants | 3, 4 |
| Pre-flight | A cleared batch, claims and rights checked | 6 |
| Test | An isolated architecture, budgets and kill rules set | 7 |
| Read | An honest winner, loser, or noise verdict | 8 |
