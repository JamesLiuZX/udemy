...
Check whether any recent rejected output ever became a fix, and put a name and a weekly cadence on reviewing them

@narrate
One thing before you move on.

Run the check from the example slide for real, on your own feature. It's
a five-minute look that usually tells you exactly where your loop is
actually open. Then assign it: a weekly thirty-minute review, owned by
one person, is enough to keep a real loop turning.
