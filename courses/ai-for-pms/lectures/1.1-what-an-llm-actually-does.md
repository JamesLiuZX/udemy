...
I want to spend this lecture on four things that follow directly from
that one sentence, because none of them are obvious from using the
product, and every one of them will eventually cost you if you don't
already know them.
...
The demo is where this mechanism looks its best. Someone picked the
prompt, and probably tried it a few times first. Production is where the
same mechanism meets an input nobody rehearsed.
...
What in the delivery would have warned them? Nothing. That's the entire
...
1. Ask a model one question only your company could answer, with no context
2. Notice whether it hedged, or answered as confidently as a correct answer would
