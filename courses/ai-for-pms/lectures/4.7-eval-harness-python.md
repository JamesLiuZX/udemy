...
Download **A04, the Python harness**, and run it against your spreadsheet's CSV export to confirm the numbers match

@narrate
One thing before you move on.

The script, exactly as shown, is A04, attached to this lecture. Copy it,
don't retype it, so a typo doesn't become your first debugging session, and
run it against your own exported scores. Confirm it agrees with the
