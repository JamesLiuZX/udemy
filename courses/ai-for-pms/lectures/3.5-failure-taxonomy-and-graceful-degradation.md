...
1. Write your feature's failure taxonomy: at least three distinct failure types
2. Name the degradation path for your most dangerous failure type

@narrate
Two things before you move on.

List at least three different ways your feature can fail, not just
"wrong." Notice how differently you'd want each one handled.

Then take the most dangerous one on that list and write down, in one
sentence, what the system actually does when it happens. If you can't
finish that sentence yet, that's this week's real work, not a detail
to leave for later.
