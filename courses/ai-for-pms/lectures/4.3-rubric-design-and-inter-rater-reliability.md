...
Download **A05, the rubric and calibration protocol**, and run its fifteen-case loop against your own golden set's rubric this week

@narrate
One thing before you move on.

The rubric template and the calibration protocol are both in A05, attached
to this lecture, with the fifteen-case loop written out as a checklist.
Run it for real, not on someone else's feature, on the rubric you're
building for your own fifty cases. Find your one bad question this week,
while it only costs you an afternoon, not a launch-week argument nobody
can settle.
