...
## A generic thirty-sixty-ninety plan could describe any PM's first quarter, at any company, whether or not AI was involved. This one can't.
lead: The plan isn't the point. Three specific, dated artifacts instead of three status updates is.
...
| Days | Milestone | Tool |
| --- | --- | --- |
| 1 to 30 | Audit what AI already touches, and where the risk sits | 1.6, 8.1 |
| 31 to 60 | Ship one small, finished proof | 4.2, 8.1 |
| 61 to 90 | Make the proof durable, without you | 9.5, 10.3 |
...
check honestly whether any of them has an eval or a risk register row
already. Most new AI PMs find at least one that has neither. That's not
a criticism of the team that came before you. It's the single most
useful thing you can hand your new manager in week two.
...
inside a month, and fix it visibly: a golden set for the most fragile
shipped feature, or the first honest row in a register that didn't
exist before you arrived. The point isn't the artifact's size. It's
that it's finished and checkable, which a plan or a proposal never is.

Days sixty-one to ninety are about durability, not a second one-off
win. Turn the single proof into something that outlives you personally
working on it: a dashboard built on 9.5's three-metric floor, so the
team can see the number without asking you directly, or a roadmap line
fixed the way 10.3 describes, so next quarter's commitment isn't
another guess. The real test of day ninety is whether a teammate could
pick this up and continue it if you left tomorrow.
...
1. Write your own thirty-sixty-ninety using this lecture's structure
2. Name the specific artifact you'd ship by day sixty, in writing
...
words is still a generic template.

Then name the day-sixty artifact specifically, not as a category but as
a real thing with a real feature attached, so day thirty-one already
knows what it's building toward.
