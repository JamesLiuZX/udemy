...
spec instead of quietly padding the bucket with lookalikes. Which would
you rather defend in a launch review: an empty bucket, or one padded to
look full? An honest gap is information. A padded one is a false sense of
coverage.
...
Download **A02, the golden dataset spec**, and sort 200 real transcripts into its four buckets this week

@narrate
One thing before you move on.

Download the golden dataset spec, attached to this lecture. It has the
four buckets built in, with space for a count and a one-line reason for
every case you add. Then do the sort while the categories are fresh: pull
your two hundred, tag them, and see what's thin. Most people find out
something uncomfortable within the first thirty cases.
