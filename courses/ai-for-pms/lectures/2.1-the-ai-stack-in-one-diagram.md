...
1. Redraw the five-layer stack from memory, no peeking
2. Label which layer your own current feature bug actually lives in

@narrate
Two things before you move on.

Redraw the five layers from memory, right now, without looking back. If
one doesn't come easily, that's the one to reread.

Then take one real bug or complaint about your own feature, and name
which layer it actually lives in. Not guess. Name it.
