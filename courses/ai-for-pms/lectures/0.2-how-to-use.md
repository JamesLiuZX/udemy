...
1. **The full build** — every section in order, exercises done. ~12 hours with the work.
...
The credibility path is Sections one, two, five and six. Take it if your immediate
problem is holding your own in technical conversations rather than shipping
...
lines of Python, so the same measurement can run automatically on every change.
Take whichever fits your situation. Most people start with the sheet.
...
@narrate
The second half is the part that tends to get PMs promoted, because it's the part
almost nobody else on the team is doing.
...
can't work. The unit economics model answers the question your CFO will
eventually ask, in the meeting where you don't want to be guessing.

And the risk register is the one that saves whole quarters. Bring it to legal at
kickoff and you get conditions. Bring it in launch week and you get a hold.

@slide callout
kicker: Practicalities
## Two things that will make this go better

::: callout Worth thirty seconds now
Turn on captions if you skim. And ==bring one real feature with you== — every
...
And more importantly: bring one real feature with you. Every exercise in this
course is written so you can do it against something from your own job instead of
a toy example. Pick the AI feature you're most unsure about right now, keep it in
mind, and by Section 8 you'll have specced, measured, costed and risk-assessed it
...
lead: Six minutes. It's the most important lecture in the course.

@narrate
Right. That's the housekeeping.

Next lecture is the one that matters most. It's six minutes, it's a single idea,
and everything else in this course is a consequence of it.
