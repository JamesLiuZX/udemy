...
Find one place your feature answers without being given the real facts, and name which fix closes the gap: grounding, verification, or neither yet
...
specifically. Then name which fix closes it: grounding, if the fact
exists somewhere you could retrieve it, or verification, if you can at
least check the answer afterwards. If neither is possible yet, that's
