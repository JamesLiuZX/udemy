...
[PULLQUOTE: More options don't reliably produce a better decision past a fairly low threshold. They reliably produce more time spent deciding and less satisfaction with whatever gets chosen.]

## A shorter selection process, deliberately limited
...
## A worked example: the two-day test in practice
...
## A concrete anchor, dated on purpose
