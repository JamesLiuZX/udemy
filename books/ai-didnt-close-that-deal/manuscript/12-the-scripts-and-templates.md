...
## 2. The specificity test (chapter 4)

Chapter four's whole craft argument compresses into one question you can run against any drafted line before it goes out: could this exact sentence have been sent to a different company by swapping one word? If the honest answer is yes, the sentence is not personalization. It is a mail-merge field wearing a personalization costume, and a skeptical recipient can tell the difference in about two seconds, which is roughly how long you get.
...
| Touch | Day | Channel | New value this touch adds (must differ from every touch before it) | Ask |
| --- | --- | --- | --- | --- |
| 1 | 0 | [ ] | [ ] | [ ] |
| 2 | [ ] | [ ] | [ ] | [ ] |
| 3 | [ ] | [ ] | [ ] | [ ] |
...
## 4. A manager one-on-one script for a resistant rep (chapter 6)
...
## 5. The AI-use checklist (chapter 7)
...
## 8. Objection quick reference (chapter 10)
