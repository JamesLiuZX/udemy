...
![The margin trap, drawn from the same numbers as the table above: a flat allocated revenue meets a cost that scales with usage, and crosses it just under 120 conversations a month.](books/stop-guessing/figures/margin-crossover.png){width=100%}
