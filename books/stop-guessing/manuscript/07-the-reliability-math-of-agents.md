...
![The same arithmetic as the table, drawn as the curves it actually is: whole-task success falls with every unchecked step, and the gap between per-step reliabilities widens as chains get longer.](books/stop-guessing/figures/reliability-decay.png){width=100%}
