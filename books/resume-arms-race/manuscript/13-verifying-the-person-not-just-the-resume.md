...
## What a reference check still catches, and what it mostly doesn't
...
## The legal floor for background checks
...
## The identity problem AI actually created
...
[PULLQUOTE: "the person in the interview" and "the person doing the job" are no longer guaranteed to be the same fact, for a small but real and growing share of remote roles, and that the fix isn't exotic technology.]
...
## What happened once Marcus actually looked
...
## Sana's role, coaching from outside the decision
...
## Try this: check your own reference-check script
