...
## A myth this chapter needs to clear first
...
[PULLQUOTE: A resume-tailoring tool, human coach or AI, works by matching a candidate's actual background against whatever language the job post rewards, and a post full of generic trait-words rewards nothing specific enough to be worth matching honestly.]

## Three edits that change what comes back
...
## Marcus rewrites the analyst posting
...
## Sana's version, from a different seat
...
## What a better posting can't do
...
## Try this: audit your current open posting
