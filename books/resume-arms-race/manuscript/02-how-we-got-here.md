...
[PULLQUOTE: The screening side was already built and standard practice years before the generation side caught up. This wasn't two new technologies colliding. It was one old system meeting a sudden flood of input built to satisfy it perfectly.]
...
The result is what any economist would predict when a filter and a generator aimed at satisfying that filter both exist in the same market: the generator gets very good, very fast, at producing exactly what the filter is looking for, and the filter's actual signal, whatever it was originally measuring, degrades in proportion. This has happened before in other domains, SEO content written to satisfy search algorithms rather than readers is the closest analogy, and it took search engines years of continuous adjustment to partially recover, never fully.
