...
## Feedback that doesn't stick isn't free. It can cost you.
...
[KEY-INSIGHT: A landmark meta-analysis of 607 effect sizes across more than 23,000 observations found that feedback interventions improved performance on average, but more than a third of them actually made performance worse. The negative effects weren't explained by sampling error or which direction the feedback pointed. They tracked instead to how the feedback was delivered: vague, one-off, or disconnected from a clear standard tended to backfire, while feedback that was specific and tied to the task itself tended to help. || Source: Kluger, A.N., & DeNisi, A., "The Effects of Feedback Interventions on Performance: A Historical Review, a Meta-Analysis, and a Preliminary Feedback Intervention Theory," Psychological Bulletin, 119(2), 1996, pp. 254-284.]
...
[PULLQUOTE: A correction that vanishes at the end of a conversation isn't a bad correction. It's a good correction with nowhere to land.]

## The difference between correcting and updating
...
## Building a correction that survives the session
...
## When a correction genuinely is one-off
...
## Try this: audit your standing instructions
