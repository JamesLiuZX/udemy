...
## Where the earlier chapters already drew this line
...
[PULLQUOTE: Any task where the output implicitly claims to be a specific person's unmediated judgment deserves the same conservative read chapter seven already taught for judgment-call tasks generally.]
